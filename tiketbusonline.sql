...
MySQL - 10.1.13-MariaDB : Database - tiketbusonline
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`tiketbusonline` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `pemesanan`(`kd_pesan`,`id_pemesan`,`kd_tiket`,`tgl_trans`,`jml_tiket`,`total_harga`,`status`) values 
(4,'0138217333199092','A0007','2018-01-24',1,75000,0),
(5,'8416893225422900','A0007','2018-01-24',1,75000,0);
...
('0138217333199092','Santoso','santoso123','santoso123','Pelanggan'),
('1234567898745632','Hadiyan','admin','admin','Admin'),
('8416893225422900','Ilham Pujianto','Ilham11','ilham11','Pelanggan'),
('8745124523145455','Dummy','pengguna1','pengguna1','Pengguna');
...
('A0001','A441H','2018-01-19','11:00:00','3273','3173',70000,50),
('A0002','D451Y','2018-01-31','10:00:00','3171','3271',50000,50),
('A0003','A441H','2018-01-26','15:00:00','3203','3273',40000,50),
('A0004','L11SD','2018-01-25','10:00:00','3209','3273',60000,45),
('A0005','K120L','2018-01-25','14:00:00','3175','3328',80000,50),
('A0007','K120L','2018-01-26','13:00:00','3173','3273',75000,47);
